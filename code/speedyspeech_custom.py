...
from hparam_custom import HPFertility as hp
...
class Encoder(nn.Module):
    ...
    def __init__(self):
        ...
        self.prenet = nn.Sequential(
            #nn.Embedding(78, hp.channels, padding_idx=0),
...
# python code/speedyspeech.py --batch_size 16 --epochs 100 --name speedyspeech_ind_a1 --durations_filename durations_aligner_ind_6300.txt
